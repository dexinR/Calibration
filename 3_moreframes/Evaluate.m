...
for i = 1:length(imgDir) % 遍历结构体就可以一一处理图片了
    ...
    for n=1:size(board_img,1)
        err(n+idx_start)=norm(board_img(n,:)-imagePoints_sort(n+idx_start,:)/10);
...
%%
img_frame = imread("220211/Picture/1.bmp");
